...
local GetSpecializationInfoByID = function() return nil end
	...
	self.options = {
		...
		args = {
			vers = {
				order = 1,
				type = "description",
				name = "|cffffd700 "..L["Version"].."|r "..self.version.string.."|cffffd700, Based on OmniBar|r v29\n",
				cmdHidden = true
			},
			desc = {
				order = 2,
...
--exportEditBox.frame:SetClipsChildren(true) -- FIXME???ddd
...
--importEditBox.frame:SetClipsChildren(true) -- FIXME???
